 ...
 * on 2016-04-22 at 22:09:47 UTC 
 * Modify at your own risk.
 */

package com.ericsson.famousquotes.entity.quoteendpoint;
...
public class Quoteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the quoteendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://localhost:8888_ah/api/";
  ...
  public class GetQuote extends QuoteendpointRequest<com.ericsson.famousquotes.entity.quoteendpoint.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.ericsson.famousquotes.entity.quoteendpoint.model.Quote.class);
   ...
   *
   * @param content the {@link com.ericsson.famousquotes.entity.quoteendpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.ericsson.famousquotes.entity.quoteendpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteendpointRequest<com.ericsson.famousquotes.entity.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.ericsson.famousquotes.entity.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "POST", REST_PATH, content, com.ericsson.famousquotes.entity.quoteendpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteendpointRequest<com.ericsson.famousquotes.entity.quoteendpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.ericsson.famousquotes.entity.quoteendpoint.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.ericsson.famousquotes.entity.quoteendpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteendpointRequest<com.ericsson.famousquotes.entity.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.ericsson.famousquotes.entity.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "PUT", REST_PATH, content, com.ericsson.famousquotes.entity.quoteendpoint.model.Quote.class);
    }
